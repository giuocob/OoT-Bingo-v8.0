...
bingoList[20] = [
  { name: "Free all 9 gorons in Fire Temple", jp: '炎の神殿で９人のゴロンを全員救う', types: ["fire", "sets"], child: "no"},
...
bingoList[25] = [
  ...
  { name: "10 Hearts", jp: 'ハート10つ', types: ["hearts", "barinade", "pganon", "volvagia", "morpha", "bongo", "twinrova"], child: "yes" },
