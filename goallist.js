...
bingoList[12] = [
  { name: "All 4 Skulltulas in Jabu-Jabu", jp: 'ジャブジャブ様のお腹の黄金のスタルチュラ4匹', types: ["jabu"], child: "yes" },
...
bingoList[17] = [
  ...
  { name: "Both Hyrule Field area Skulltulas", jp: 'ハイラル平原エリアの黄金ノスタルチュラ2匹', types: ["zl","water"], child: "yes" },
...
bingoList[19] = [
  ...
  { name: "Beat the Fire Temple", jp: '炎の神殿クリア', types: ["fire","forest"], child: "no" },
...
bingoList[22] = [ 
  ...
  { name: "All 4 Market area Skulltulas", jp: '城下町エリアの黄金のスタルチュラ4匹', types: ["forest"], child: "no" },
...
bingoList[25] = [
  ...
  { name: "10 Hearts", jp: 'ハート10つ', types: ["hearts"], child: "yes" },
